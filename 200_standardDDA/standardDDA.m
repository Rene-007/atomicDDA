...
spacing = 5.0;                                   % dipole spacing in nm
...
for i = 1:length(wavelengths)
    ...
    switch solver
        ...
        case 2
          ...
          [P,flag,relres,iter] = ccg_Sarkar(C, Ei, tol, maxit);     
          %[P,flag,relres,iter] = ccg_Draine(C, Ei, tol, maxit);     
          %[P,flag,relres,iter] = ccg_Petravic(C, Ei, tol, maxit);   
        case 3
          % Quasi-Minimal Residual Method -- Matlab
          [P,flag,relres,iter] = qmr(C, Ei, tol, maxit);            
        case 4
          % BiConjugate Gradients Method -- own implementations
          [P,flag,relres,iter] = bcg_Sarkar(C, Ei, tol, maxit);       
          %[P,flag,relres,iter] = bcg_Press(C, Ei, tol, maxit);     

function fftA = create_fftA_gpu(Aj,k,r)
...
%   
%  Aj is used as a parameter to prevent reallocation of memory on the GPU
%  (the content is no importance)
    ...
    vars = {'beta','C','gamma','r','r_all','r_center','r_ij','r_ij_vec','rt_ij'};
    clear(vars{:})
    
    % and then do the transformation
    fftA = fft(Aj);                                 % no gathering this time to leave the array on the GPU

...
% lattice = Lattice_SCP(spacing);                % simple cubic packing
...
geometry = Geo_SpheroidPair([0 0 0], 10,5,2);    % Parameters (center, long_axis, short_axis, gap)
...
draw_field( '2nd', r0(r_on,:), P_store(:,exci.i), exci, scale, mask_dipole, "xy", 0.0, [[-30 1/6 30]; [-10 1/6 10]] );  % center: fine resolution

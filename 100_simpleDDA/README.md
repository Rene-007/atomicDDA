...
<div align="center"><img style="background: white;" src="..\003_media\7trO95kowA.svg"></div>  
...
This means, only the inverse matrix of <!-- $\mathbf{C}$ --> <img style="transform: translateY(0.0em); background: white;" src="..\003_media\PUJZU6MhJT.svg"> needs to be calculate and multiplied with the excitation field in order to solve the problem.
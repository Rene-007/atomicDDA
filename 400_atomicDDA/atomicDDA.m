...
for i = 1:length(wavelengths)
    ...
    rho = (wav/spacing)^3;                       % number of dipoles per unit volume for the normal (cubic) case
    rho_hex = sqrt(2) * rho;                     % and for the hexagonal case
    ...
    alpha = alpha_CM(rho_hex,n_rel);             % polarizability of the dipoles
